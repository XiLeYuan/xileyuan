...
class AvatarCropEngine : CropEngine {
    override fun onStartCrop(
        ...
        val fileName = "CROP_AVATAR_$timeStamp.jpg"
        ...
        val options = UCrop.Options().apply {
            ...
            // 设置裁剪比例：高大于宽（3:2，高度:宽度）
            withAspectRatio(2f, 3f) // aspectRatioX = 2, aspectRatioY = 3，表示高度是宽度的1.5倍
            
            // 设置是否显示网格
            setShowCropGrid(true)
            
            // 设置是否自由裁剪（false表示固定比例）
